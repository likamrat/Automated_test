...
* Edit the extensions parameters file for [*Windows*](./customscript-templatewindows.parameters.json) or for[*Linux*](./customscript-templatewindows.parameters.json)
