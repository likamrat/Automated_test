...
* You will also need to have a Log Analytics Workspace deployed. You can automate the deployment by editing the ARM template [parameters file](./log_analytics-template.parameters.json) and provide a name and location for your workspace. 
...
* Edit the [*extensions parameters file*](./mma-template.parameters.json) 
...
* Choose the ARM template that matches your Operating System, for [*Windows*](./mma-template-windows.json) and [*Linux*](./mma-template-linux.json), deploy the template by running the following command: 
