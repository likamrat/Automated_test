...
1. User edit the [*vars.ps1*](./vars.ps1) PowerCLI script

2. Upon execution of the [*scale_deploy.ps1*](./scale_deploy.ps1) PowerShell script:
...
Before running the PowerCLI script, you must set the [environment variables](./vars.ps1) which will be used by the *install_arc_agent.sh* script. These variables are based on the Azure Service Principal you've just created, your Azure subscription and tenant, and your VMware vSphere credentials and data.
