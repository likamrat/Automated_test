...
If you delete the instance manually, then you should also delete [install_arc_agent.sh](./scripts/install_arc_agent.sh) which is created by the Terraform plan.
