...
1. Before running the ```terraform apply``` command, open [*main.tf*](./main.tf) and comment out the ```windows-startup-script-ps1 = local_file.install_arc_agent_ps1.content``` line and save the file.
